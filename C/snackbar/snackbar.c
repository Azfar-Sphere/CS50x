...
// Checks if entered item is on menu
int linear_search(string item);
...
// Checks if item is in menu, if not in menu reprompts user
int linear_search(string item)
{
    for (int i = 0; i < NUM_ITEMS; i++ )
    {
...
printf("Please enter a Valid Item from the Menu\n");
return 1;
}